...
const MessageContainer = ({onBackUser}) => {
  ...
  const{message,setSelectedConversation,setMessage,selectedConversation}=userConversation();
  ...
  return (
    <div className='md:min-w-[500px] h-screen flex flex-col py-2'>
      ...
      <div className='flex justify-between gap-1 bg-sky-600 md:px-2 rounded-lg h-10'>
       <div className='flex gap-2 md:justify-between items-center w-full'>
        <div className='md:hidden ml-1 self-center'> 
          <button className='bg-white rounded-full px-2 py-1 self-center' 
